...
venue: "Introduction to R<br>Nathan Campus, Griffith University"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Kessels Rd, Nathan, Brisbane"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "13th and 14th Aug"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Heidi Perrett", "Ido Bar", "Amanda Miotto"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Conrad Leonard"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<p><a href="https://www.surveymonkey.com/r/swc_pre_workshop_v1?workshop_id={{ site.github.project_title }}">Pre-workshop Survey</a></p>
<p><a href="https://www.surveymonkey.com/r/swc_post_workshop_v1?workshop_id={{ site.github.project_title }}">Post-workshop Survey</a></p>
{% elsif page.carpentry == "dc" %}
  <p>Please be sure to complete these surveys before and after the workshop.</p>
...
{% comment %}<div id="python">  Start of 'Python' section. Remove the third paragraph if
